...
Air_friction = 3.4*10**(-2) # [1/s^2] # used in integration scheme as well as for plots
...
def _pendulum_in_configuration_space__lagrangian():
    ...
    def g(y):
        ...
        d2_theta = (d_phi**2 * c - GRAVITY_ACC / PENDULUM_LENGTH) * s - Air_friction * d_theta
        d2_phi = -2 * d_theta * d_phi / t - Air_friction * d_phi
...
class PlotStream:
    ...
    def __init__(self, stream):
        ...
        self.__ax = self.__fig.add_axes(Axes3D(self.__fig))
    ...
    def run(self):
        ...
        """
        _animation = animation.FuncAnimation(self.__fig,
